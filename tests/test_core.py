...
class TestMachineTypeDiscountMapping(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create a dummy discount file for testing
...
""")
    ...
    def test_get_discount(self):
        """Test that the correct discount is returned for a given machine type."""
    ...
    def test_get_family(self):
        ...
        self.assertEqual(self.discount_mapping.get_family('e2-micro'), 'General Purpose')
...
class TestCUDAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = {
            'analysis': {
                ...
                'stable_workload_percentage': 0.7,
            }
        }
    ...
    def test_calculate_savings_by_machine(self):
        ...
        # Check n1 savings
        n1_savings = savings['n1']
        self.assertAlmostEqual(n1_savings['resource_cud_1yr']['monthly_savings'], 300 * 0.7 * 0.37)
        self.assertAlmostEqual(n1_savings['resource_cud_3yr']['monthly_savings'], 300 * 0.7 * 0.55)

        # Check e2 savings
        e2_savings = savings['e2']
        self.assertAlmostEqual(e2_savings['flex_cud_1yr']['monthly_savings'], 50 * 0.7 * 0.28)
